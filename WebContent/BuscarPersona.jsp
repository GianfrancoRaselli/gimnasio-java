...
<body style="background-color:#E1E1E1; padding-right: 1%; padding-left: 1%;">
		    ...
		    <ul class="navbar-nav">
		      ...
		      <li class="nav-item dropdown">
		        <a style="color: orange" class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Cuotas</a>
		      	<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
					<a style="background-color: orange" class="dropdown-item" href="PagarCuota.jsp">Pagar cuota</a> 
					<a class="dropdown-item" href="PagarCuota.jsp">Mis cuotas</a> 
		        </div>
		      </li>
		      <li class="nav-item dropdown">
		...
		<form action="ControladorPagarCuotas" method="post" name="persona" style="margin-top: 3%;">
